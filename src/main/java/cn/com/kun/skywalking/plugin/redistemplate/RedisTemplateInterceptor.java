...
public class RedisTemplateInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public static final OfficialComponent CUSTOM_OFFICIAL_COMPONENT2 = new OfficialComponent(8200, "SkywalkingDemoService22");
    ...
    public void beforeMethod(EnhancedInstance enhancedInstance, Method method, Object[] objects, Class<?>[] classes, MethodInterceptResult methodInterceptResult) throws Throwable {
        ...
        AbstractSpan span = ContextManager.createLocalSpan("RedisTemplate.get");
        /*
